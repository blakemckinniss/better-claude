...
This module analyzes user prompts to recommend the 3 most relevant MCP tools from the
available set, providing contextual examples and usage guidance.
"""
...
class MCPInjector:
    ...
    def __init__(self):
        ...
        self.mcp_tools = {
            "zen": {
                ...
                "example": "mcp__zen__chat(prompt='How should I approach implementing "
                "this feature?', model='anthropic/claude-opus-4', use_websearch=True)",
            },
            "filesystem": {
                ...
                "example": "mcp__filesystem__read_multiple_files("
            ...
            "tavily": {
                ...
                "example": "mcp__tavily-remote__tavily_search("
                "query='React hooks best practices 2025', max_results=5)",
            },
            "tree_sitter": {
                ...
                "example": "mcp__tree_sitter__analyze_complexity("
                "project='better-claude', file_path='src/main.py')",
            },
            "github": {
                ...
                "example": "mcp__github__create_issue(owner='user', repo='project', "
                "title='Bug: Error in login', body='Details...')",
            },
            "playwright": {
            ...
            "memory": {
                ...
                "example": "mcp__better-claude-memory__search_similar("
    ...
    def get_tool_recommendations(self, prompt: str, max_tools: int = 3) -> List[Dict]:
        ...
        for tool_name, tool_info in self.mcp_tools.items():
            ...
            if score > 0:
                tool_scores.append(
                    {"name": tool_name, "info": tool_info, "score": score},
                )
        ...
        for rec in recommendations:
            rec["reason"] = self.generate_reason(
                rec["name"],
                intents,
                languages,
                prompt,
...
if __name__ == "__main__":
    ...
    for prompt in test_prompts:
        ...
        print(get_mcp_injection(prompt), file=sys.stderr)
